...
The script compiles every test classes located at the test folder before any test execution. So, if you modify a an existing test class, the next time you run one of the test commands described above the modifications will be compiled. 
